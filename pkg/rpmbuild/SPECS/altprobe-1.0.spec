...
install -m 0755 $RPM_SOURCE_DIR/scripts/iprepup-modsec.sh $RPM_BUILD_ROOT/etc/altprobe/scripts/iprepup-modsec.sh
...
install -m 0755 $RPM_SOURCE_DIR/scripts/altprobe-update $RPM_BUILD_ROOT/usr/sbin/altprobe-update
...
/etc/altprobe/scripts/iprepup-modsec.sh
