...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/altprobe_github: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/altprobe_github ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/graylog.o: src/graylog.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/graylog.o src/graylog.cpp
...
${OBJECTDIR}/src/ntop.o: src/ntop.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ntop.o src/ntop.cpp

${OBJECTDIR}/src/ossec.o: src/ossec.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ossec.o src/ossec.cpp

${OBJECTDIR}/src/pobject.o: src/pobject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pobject.o src/pobject.cpp

${OBJECTDIR}/src/sinks.o: src/sinks.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sinks.o src/sinks.cpp

${OBJECTDIR}/src/suricata.o: src/suricata.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/suricata.o src/suricata.cpp
