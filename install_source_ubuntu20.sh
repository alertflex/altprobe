...
then
    ...
    sudo chmod u+x dpkg/altprobe_1.0-3/usr/local/bin/altprob*
    sudo cp -rp dpkg ~
    sudo cp /usr/local/bin/altprobe ~/dpkg/altprobe_1.0-3/usr/local/bin/
    sudo mkdir ~/dpkg/altprobe_1.0-3/usr/local/lib/
