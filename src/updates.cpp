        ...
        if (!node.compare(node_id)) {
            ...
            if (!msg_type.compare("byte")) {
                ...
                if (!content_type.compare("config") && uploadStatus) {
                    ...
                    if (!sensor.compare("master-hids") || !sensor.compare("master-nids")) {
                        
                        if (sensor_id.compare("master")) return;
                        
                    } else {
                        
                        if (sensor.compare(sensor_id)) return;
...
int Updates::SendToIpset(string ip) {
