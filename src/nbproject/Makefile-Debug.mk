...
# CC Compiler Flags
CCFLAGS=-I/usr/include/ -I/usr/include/boost -I/usr/local/include/hiredis -I/usr/local/include/activemq-cpp-3.10.0/ -I/usr/include/apr-1.0/ -DBIG_JOINS=1 -D_REENTERANT -g -Wno-write-strings -fno-strict-aliasing -pthread -std=gnu++0x
CXXFLAGS=-I/usr/include/ -I/usr/include/boost -I/usr/local/include/hiredis -I/usr/local/include/activemq-cpp-3.10.0/ -I/usr/include/apr-1.0/ -DBIG_JOINS=1 -D_REENTERANT -g -Wno-write-strings -fno-strict-aliasing -pthread -std=gnu++0x
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/collector: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/collector ${OBJECTFILES} ${LDLIBSOPTIONS} -L/usr/lib -L/usr/local/lib -L/usr/lib/x86_64-linux-gnu -lz -lm -lrt -ldl -lpthread -lzmq -lyaml -ldaemon -lactivemq-cpp -lboost_system -lboost_thread -lboost_iostreams -lhiredis -lGeoIP -lboost_filesystem -lhiredis
...
${OBJECTDIR}/filelog.o: filelog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/filelog.o filelog.cpp
...
${OBJECTDIR}/flushlog.o: flushlog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/flushlog.o flushlog.cpp
...
${OBJECTDIR}/netflow.o: netflow.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/netflow.o netflow.cpp
...
${OBJECTDIR}/statflow.o: statflow.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/statflow.o statflow.cpp

${OBJECTDIR}/statids.o: statids.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/statids.o statids.cpp
