...
* Cyber threat hunting (The Open Source Threat Intelligence Platform MISP is used). Alertflex controller generates alert in case of matching an IOC from MISP with IDS event data.
